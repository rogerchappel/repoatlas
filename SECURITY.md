...
Replace this section with the supported versions for `repoatlas`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `repoatlas` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in repoatlas.
